...
| **Pillar**  | **Spirals**    | **Overreaching Theme**      |
| - | --- | - |
| **Hero**    | - Custody Chain  <br> - Crisis Promotions  <br> - Burnout Reassignments  <br> - Symbolic Authority | **Audit Contagion Bureaucracy**  <br>Survival = paperwork. Merit is irrelevant. Systems reward structure, not truth.   |
| **World**   | - Frontier Emergence<br>- Stabilization Era <br> - RC Overreach | **Push-then-Drift Cycles**  <br>Systems can’t learn — they surge, collapse, then forget. Infrastructure survives, not clarity. |
| **Mystery** | - Artifact Discovery  <br> - Enceladus Forensics  <br> - Origin Hunt  <br> - Contact Dilemma | **Ambiguity as Economic Engine**  <br>The unknown isn’t feared — it’s monetized. Truth is risk. Fog becomes ritual. |
...
| Pillar      | Master Theme | What It Really Says   |
| - | -- | -- |
| **Hero**    | **Audit Contagion Bureaucracy**  | Survival = paperwork. Merit is irrelevant. Systems reward those who *generate structure*, not truth.  Audit layering becomes survival mechanism amid orbital/naval growth -> audit logic dominates risk strategy; fallback documents valued more than action. Emerges quietly: not from a single trigger, but from many minor incidents. Grows as orbitals, navy, and contractors expand.  |
